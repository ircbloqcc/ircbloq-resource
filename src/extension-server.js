const IrcBloqResourceServer = require('./server');
 ...
 */
class IrcBloqExtension extends IrcBloqResourceServer{

    /**
     * Construct a IrcBloq extension server object.
...
module.exports = IrcBloqExtension;
