 ...
 * @readonly
 */
const DEFAULT_USER_DATA_PATH = path.join(__dirname, '../../.ircbloqData');
 ...
 * @readonly
 */
const SERVER_NAME = 'ircbloq-resource-server';

/**
 * The time interval for retrying to open the port after the port is occupied by another ircbloq-resource server.
 * @readonly
 */
