 ...
 *
 * use --repo to specify the download address, e.g: --repo=ircbloqcc/external-resources
 * use --cdn to specify the use of the cdn proxy server address, e.g: --cdn=https://cdn.ircbloq.cc/
 */
